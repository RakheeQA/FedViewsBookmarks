...
public class MultiBrowserHeadlessOrg12 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread user2 = new Thread(() -> runEdge("profile2", "rudresh052@govstrive.com", "password"));
        Thread user3 = new Thread(() -> runEdge("profile3", "rudresh053@govstrive.com", "password"));
        Thread user4 = new Thread(() -> runEdge("profile4", "rudresh054@govstrive.com", "password"));
        Thread user5 = new Thread(() -> runEdge("profile5", "rudresh055@govstrive.com", "password"));
        Thread user6 = new Thread(() -> runEdge("profile6", "rudresh056@govstrive.com", "password"));
        Thread user7 = new Thread(() -> runEdge("profile7", "rudresh057@govstrive.com", "password"));
        Thread user8 = new Thread(() -> runEdge("profile8", "rudresh058@govstrive.com", "password"));

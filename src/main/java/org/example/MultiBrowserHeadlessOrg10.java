...
public class MultiBrowserHeadlessOrg10 {
    ...
    public static void runEdge(String profileDirName, String username, String password) {
        try {
            ...
            // File profileDir = new File("C:/Temp/ChromeProfiles/" + profileDirName);
            ...
            // options.addArguments("user-data-dir=C:/Temp/ChromeProfiles/" +
            // profileDirName);

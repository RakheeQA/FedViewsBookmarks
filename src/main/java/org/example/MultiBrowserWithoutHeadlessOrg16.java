...
public class MultiBrowserWithoutHeadlessOrg16 {
    ...
    public static void runEdge(String profileDirName, String username, String password) {
        try {
            ...
            // Locate the node for 16-HAR TEST OFFICE C
            WebElement node16 = driver.findElement(By.xpath("//span[text()='16-HAR TEST OFFICE C']"));

            // Just scroll the node into view (no center)
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", node16);

            // Optional: short wait after scrolling
            Thread.sleep(500);

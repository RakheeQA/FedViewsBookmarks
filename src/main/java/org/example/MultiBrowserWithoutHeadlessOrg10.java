...
public class MultiBrowserWithoutHeadlessOrg10 {

    public static void main(String[] args) throws InterruptedException {

        // Launch 8 Edge browsers in parallel
        // Launch 8 Edge browsers in parallel
        // Thread user1 = new Thread(() -> runEdge("profile1",
        // "rudresh051@govstrive.com", "Rudresh1008387#"));
        // Thread user2 = new Thread(() -> runEdge("profile2",
        // "rudresh052@govstrive.com", "Rudresh1008387#"));
        // Thread user3 = new Thread(() -> runEdge("profile3",
        // "rudresh053@govstrive.com", "Rudresh1008387#"));
        // Thread user4 = new Thread(() -> runEdge("profile4",
        // "rudresh054@govstrive.com", "Rudresh1008387#"));
        // Thread user5 = new Thread(() -> runEdge("profile5",
        // "rudresh055@govstrive.com", "Rudresh1008387#"));
    ...
    public static void runEdge(String profileDirName, String username, String password) {
        try {
            ...
            driver.findElement(By.xpath("//span[normalize-space(text())='CENTERS FOR DISEASE CONTROL AND PREVENTION']"))
                    .click();// click on agency name
            Thread.sleep(2000);
            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".MuiLinearProgress-root"))); // wait
                                                                                                                    // for
                                                                                                                    // loader
                                                                                                                    // to
                                                                                                                    // disappear
            ...
            // Navigate to 10
            WebElement toggler99 = driver.findElement(By.xpath(
                    "//span[text()='99-CENTERS FOR DISEASE CONTROL AND PREVENTION']/preceding-sibling::a[contains(@class,'jqtree-toggler')]"));
            toggler99.click();
            Thread.sleep(1000); // wait for child nodes to load
            // Expand the node by clicking the toggler
            driver.findElement(By.xpath("//span[text()='10-TALENT ACQUISITION']")).click();
            ...
            for (int i = 1; i <= 500; i++) {
                // Modal Form
                driver.findElement(By.xpath("//button[@class='btn btn-primary govstrive-button1']")).click(); // click
                                                                                                              // on
                                                                                                              // Add/Remove
                                                                                                              // position
                                                                                                              // at
                                                                                                              // navbar
                driver.findElement(By.xpath("//button[text()='Add New Position']")).click(); // click on add new
                                                                                             // position button for
                                                                                             // modal
                ...
                List<WebElement> dropdowns = driver
                        .findElements(By.cssSelector(".search-wrapper.searchWrapper.singleSelect"));
                ...
                List<WebElement> gradeContainers = driver
                        .findElements(By.cssSelector(".search-wrapper.searchWrapper.singleSelect"));
                ...
                // int randomFourDigit = 1000 + rand1.nextInt(9000); // Ensures 4-digit number
                // String positionNumber = "org10" + randomFourDigit;

                // WebElement positionNumberInput =
                // wait.until(ExpectedConditions.presenceOfElementLocated(
                // By.xpath("//input[@placeholder='Position Number (Optional)']")
                // ));
                // ((JavascriptExecutor)
                // driver).executeScript("arguments[0].scrollIntoView({block: 'center'});",
                // positionNumberInput);
                // positionNumberInput.sendKeys(positionNumber);
                ...
                for (WebElement option : options3) {
                    if (option.getText().trim().equals("AC00,104,AN001")) {
                        ...
                        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", option); // Use JS click
                                                                                                      // for robustness
                        break;
                    }
                }
                ...
                wait.until(
                        ExpectedConditions.visibilityOfElementLocated(By.cssSelector("ul.select-search-box__options")));
                // Step 3: Find the option with data-value='0201'
                WebElement occOption = driver
                        .findElement(By.cssSelector("li.select-search-box__option[data-value='0201']"));
                ...
                // click search button
                List<WebElement> searchButtons = driver
                        .findElements(By.cssSelector("button.btn.btn-primary.new-btn-design"));
                ...
                WebElement icon = wait
                        .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("tr.pdDataRows")))
                        .get(2)

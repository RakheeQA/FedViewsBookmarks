...
public class MultiBrowserWithoutHeadlessOrg07 {
    ...
    public static void runEdge(String profileDirName, String username, String password) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(820));
            ...
            driver.findElement(By.xpath("//span[text()='07-REGION B']")).click();

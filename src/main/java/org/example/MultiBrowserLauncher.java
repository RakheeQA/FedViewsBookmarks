...
public class MultiBrowserLauncher {

    public static void main(String[] args) {

        // Launch 4 Edge browsers in parallel
        ...
        Thread user5 = new Thread(() -> runEdge("profile2", "rudresh055@govstrive.com", "password"));
        Thread user6 = new Thread(() -> runEdge("profile3", "rudresh056@govstrive.com", "password"));
        Thread user7 = new Thread(() -> runEdge("profile4", "rudresh057@govstrive.com", "password"));
        Thread user8 = new Thread(() -> runEdge("profile4", "rudresh058@govstrive.com", "password"));
    ...
    public static void runEdge(String profileDirName, String username, String password) {
        try {
            ...
            // Login
            // driver.findElement(By.id("username")).sendKeys("rudresh051@govstrive.com");//
            // email
